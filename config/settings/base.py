...
AI_INTAKE_MAX_QUESTIONS = env.int("AI_INTAKE_MAX_QUESTIONS", default=12)
AI_INTAKE_MAX_ANSWER_LENGTH = env.int("AI_INTAKE_MAX_ANSWER_LENGTH", default=2000)
AI_INTAKE_MAX_ASSISTANT_LENGTH = env.int("AI_INTAKE_MAX_ASSISTANT_LENGTH", default=1000)
AI_INTAKE_MAX_HISTORY_MESSAGES = env.int("AI_INTAKE_MAX_HISTORY_MESSAGES", default=20)
AI_INTAKE_MAX_PROMPT_TOKENS = env.int("AI_INTAKE_MAX_PROMPT_TOKENS", default=6000)
AI_INTAKE_MAX_OUTPUT_TOKENS = env.int("AI_INTAKE_MAX_OUTPUT_TOKENS", default=1200)
AI_INTAKE_MAX_SESSION_TOKENS = env.int("AI_INTAKE_MAX_SESSION_TOKENS", default=40000)
AI_INTAKE_MAX_RETRIES = env.int("AI_INTAKE_MAX_RETRIES", default=2)
AI_INTAKE_LIVE_EVAL_ENABLED = env.bool("AI_INTAKE_LIVE_EVAL_ENABLED", default=False)
AI_INTAKE_EVAL_MAX_LIVE_CASES = env.int("AI_INTAKE_EVAL_MAX_LIVE_CASES", default=25)
AI_INTAKE_EVAL_MAX_INPUT_TOKENS = env.int("AI_INTAKE_EVAL_MAX_INPUT_TOKENS", default=3000)
AI_INTAKE_EVAL_MAX_OUTPUT_TOKENS = env.int("AI_INTAKE_EVAL_MAX_OUTPUT_TOKENS", default=800)
